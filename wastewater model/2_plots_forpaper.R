...
gg1 <- results$station_ave_df %>% 
  ...
  theme(axis.text.x.top = element_text(vjust = -65),
...
ggsave(filename = paste0("./wastewater model/plots/allsignals_CAN_wastewatermodel_a.pdf"),
       plot = a, 
       device = "pdf",
       width = 8, 
       height = 8/3,
       dpi = 300)
rstudioapi::viewer(paste0("./wastewater model/plots/allsignals_CAN_wastewatermodel_a.pdf"))

b = gg2+ theme(axis.text.x.top = element_text(vjust = -78))
ggsave(filename = paste0("./wastewater model/plots/allsignals_CAN_wastewatermodel_b.pdf"),
       plot = b, 
       device = "pdf",
       width = 8, 
       height = 8/3,
...
c = gg3+ theme(axis.text.x.top = element_text(vjust = -78))
ggsave(filename = paste0("./wastewater model/plots/allsignals_CAN_wastewatermodel_c.pdf"),
       plot = c, 
       device = "pdf",
       width = 8, 
       height = 8/3,
       dpi = 300)
rstudioapi::viewer(paste0("./wastewater model/plots/allsignals_CAN_wastewatermodel_c.pdf"))
